...
export const meta: MetaFunction = () => {
  return [
    { title: "Saumya Patil" },
    { name: "description", content: "I'm Saumya Patil, and I'm a web developer from Kolhapur, India." },
  ];
};
    ...
    <>
      <div className="flex px-8 md:px-24 py-4 flex-col md:flex-row bg-gradient-to-b from-background-900 from-0% to-80% to-transparant">
        <div className="flex-grow">
          <h1 className="text-2xl font-heading font-bold">Saumya Patil</h1>
        </div>
    ...
    <>
      <div className="bg-gradient-to-b from-primary-900 to-30% to-secondary-800 text-center p-12 pt-20">
        <p className="text-xl text-text-200">
          &copy; 2023 Saumya Patil, All rights reserved.
        </p>
      </div>
    </>
  );
    ...
    return (
        ...
        >
            ...
            <p className="md:text-xl max-w-4xl">
                I'm Saumya Patil, and I'm a web developer from Kolhapur, India.
            </p>
        </section>
    );
}
                ...
                <ul className="grow max-w-4xl flex flex-col gap-4 font-bold">
                    <li className="flex flex-row">
                        ...
                        <span>
                            Email me at{" "}
                            <a
                                href="mailto:saumyasachinpatil@gmail.com"
                                className="underline"
                            >
